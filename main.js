...
function yomiage_text_plus(nakami,i,naiyou,hizuke){
	var plus_bun = "";
	if(naiyou == "tenki"){
		if(lang == "ja"){
			if(i == 0){
	...
	//alert(nakami)
	//alert(yomiage_text)
	if(i == 0) yomiage_text += nakami;
	if(i == 0) yomiage_text_d0 += nakami;
	if(i == 1) yomiage_text_d1 += nakami;
	if(i == 2) yomiage_text_d2 += nakami;
	if(i == 3) yomiage_text_d3 += nakami;
	if(i == 4) yomiage_text_d4 += nakami;
	if(i == 5) yomiage_text_d5 += nakami;
	if(i == 6) yomiage_text_d6 += nakami;
	if(i == 7) yomiage_text_d7 += nakami;
	//alert(yomiage_text)
}
...
function read_debug(){
	//読み上げ内容をコンソールログに。
	console.log("0日目 : " + yomiage_text_d0);
	console.log("1日目 : " + yomiage_text_d1);
	console.log("2日目 : " + yomiage_text_d2);
	console.log("3日目 : " + yomiage_text_d3);
	console.log("4日目 : " + yomiage_text_d4);
	console.log("5日目 : " + yomiage_text_d5);
	console.log("6日目 : " + yomiage_text_d6);
	console.log("7日目 : " + yomiage_text_d7);
}
function lang_chg(){
